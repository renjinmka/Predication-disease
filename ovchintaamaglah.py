...
def predict():
    ...
    match prediction:
        ...
        case "Common_Cold":
            disease = "Ханиад"
            tailbar = "Ханиад нь хамар, хоолойн вируст халдвар юм. Энэ нь ихэвчлэн хор хөнөөлгүй байдаг ч тийм мэдрэмж төрдөггүй. Олон төрлийн вирус нь ханиад үүсгэдэг."
            sergiileh = "С витаминаар баялаг ундаа уух, хүйтэн хоол идэхээс зайлсхийх, халууралтыг хянах"
        case "Chicken_pox":
